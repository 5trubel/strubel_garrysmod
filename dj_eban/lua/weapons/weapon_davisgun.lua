...
AddCSLuaFile()
AddCSLuaFile( "effects/marcel_tracer.lua" )
AddCSLuaFile( "effects/marcel_bounce.lua" )
...
SWEP.Primary.Ammo = "marcel"

game.AddAmmoType( { name = "marcel" } )
if ( CLIENT ) then language.Add( "davids_ammo", "Funny Ammo" ) end

/* --------------------------------- TTT ---------------------------------- */

SWEP.EquipMenuData = {
	type = "item_weapon",
	desc = [[The Davis Gun. Provides:
	* Blown cover
	* Annoying sounds
...
SWEP.Icon = "marcel/johnny_davis_icon.png"
...
function SWEP:PrimaryAttack()
	...
	if ( IsFirstTimePredicted() ) then
		...
		bullet.TracerName = "marcel_tracer"
...
function SWEP:DoImpactEffect( trace, damageType )
	...
	util.Effect( "marcel_bounce", effectdata )
...
function SWEP:KillSounds()
	...
	timer.Destroy( "narcel_idle" .. self:EntIndex() )
end
...
killicon.Add( "johnny_davis_icon2", "marcel/killicon", color_white )

SWEP.WepSelectIcon = Material( "marcel/selection.png" )
